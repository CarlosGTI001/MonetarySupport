<div class="d-flex justify-content-between align-items-center mb-5 no-print">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="?module=reports&action=view&type=<?= e($type) ?>&format=pdf_lib" class="btn btn-danger btn-sm rounded-pill px-4 fw-bold shadow-sm">
            <i class="bi bi-file-pdf me-2"></i> Descargar PDF
        </a>
        <a href="?module=reports&action=view&type=<?= e($type) ?>&format=excel" class="btn btn-success btn-sm rounded-pill px-4 fw-bold shadow-sm">
